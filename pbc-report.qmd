...
singlepltfunc <- function(df, package) { 
  return(
    ...
    geom_line(color = posit_colors$blue) +  
...
::: {.page-banner fill="posit_colors.light_blue_1" image_paths='("assets/images/quarto-logo-dark.svg",)'}
...
quarto_by_version %>%
  ggplot(aes(minor_version, cumsum(total))) +
    geom_line(aes(group = 1), color = posit_colors$blue) + 
    scale_y_continuous(
      labels = scales::label_number(scale_cut = scales::cut_short_scale())
    ) +
    xlab("Minor Version") +
...
::: {.page-banner fill="posit_colors.light_blue_1" image_paths='("assets/images/shiny-logo.png",)'}
...
There are approximately [6.5 full
...
[sparklyr](https://spark.posit.co/), [tensorflow for
...
::: {.page-banner fill="posit_colors.light_blue_1" image_paths='("assets/images/hexes/devtools.svg","assets/images/hexes/usethis.svg")' image_height="75%"}
