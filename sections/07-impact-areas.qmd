...
2024, we formalized this commitment by joining the
[Open Source Pledge](https://posit.co/blog/posit-pledge-to-support-open-source),
pledging to invest at least \$2,000 per developer each year in the wider
open-source ecosystem -- a floor we've cleared several times over. To
date, Posit has given over \$3.3M to projects led by others. Current
commitments
...
[Jupyter Foundation](https://opensource.posit.co/blog/2026-06-25_posit-joins-jupyter-foundation/)
as a general member.
Posit's tools build on the Jupyter ecosystem, and membership helps fund
its core infrastructure, release engineering, and community events.
...
so that we can purchase an equal amount of carbon offsets. We direct our purchases of 
carbon offsets towards Nature-Based Removals like reforestation and Technology-Based Removals like Direct Air Capture.
